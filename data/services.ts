...
export const services: Service[] = [
  {
    ...
    features: [
      ...
      "Resin and epoxy anchor systems",
      "Structural steel and rebar connections",
  ...
  },
  {
    ...
    features: [
      ...
      "Saw cutting with minimal dust and noise",
      "Reinforcement-friendly cutting methods",
      "Post-cut edge treatment and sealing",
    ],
  },
  {
    id: "3",
    ...
    features: [
      ...
      "Cover blocks and spacer installation",
      "Quality checks and bar bending schedules",
    ],
  },
  {
    id: "4",
    ...
    features: [
      ...
      "Groove filling with epoxy or sealants",
  ...
  },
  {
    ...
    features: [
      ...
      "Dust-free wet drilling option",
      "Reinforcement-friendly core locations",
      "Clean, precise openings for pipes and ducts",
    ],
  },
  {
    id: "6",
  ...
  {
    id: "7",
    title: "Concrete Drilling",
    description:
      "Precision drilling in concrete and masonry for anchors, dowels, and fixings using diamond and carbide tools for clean, accurate holes.",
    icon: "Drill",
    features: [
      "Anchor and dowel hole drilling",
      "Multiple diameters and depths",
      "Horizontal and overhead drilling",
      "Dust extraction and clean work area",
      "Suitable for heavy-duty fixings",
    ],
  },
  {
    id: "8",
    ...
    features: [
      ...
      "Bridge piers, dams, and foundations",
      "Minimum vibration and dust",
      "Precision cuts in difficult access areas",
    ],
  },
];
